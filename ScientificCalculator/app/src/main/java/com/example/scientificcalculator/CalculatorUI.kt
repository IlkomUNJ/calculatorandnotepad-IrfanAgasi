                    ...
                    FlowRow(
                        ...
                        for (i in scientificList) {
                            CalculatorButton(
                                ...
                                buttonColor = when (i) {
                                    "DEG" -> if (isDegreeMode) Color(0xff126e69) else Color(
                                        0xff0c2a36
                                    )

                                    "RAD" -> if (!isDegreeMode) Color(0xff126e69) else Color(
                                        0xff0c2a36
                                    )
                                    ...
                                    when (i) {
                                        "1/x" -> {
                                            ...
                                            if (match != null) {
                                                ...
                                                displayText =
                                                    displayText.dropLast(lastNumber.length)
                            ...
                            "." -> CalculatorButton(
                                ...
                                buttonAction = {
                                    if (displayText.isNotEmpty()) {
                                        ...
                                        if (lastChar.isDigit()) {
                                            val lastNumber =
                                                displayText.takeLastWhile { it.isDigit() || it == '.' }
...
fun CalculatorDisplay(
    ...
    Box(
        modifier = modifier
            .fillMaxWidth()
            .heightIn(min = 500.dp, max = 250.dp)
